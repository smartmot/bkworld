...
@section("head_link")
    <a class="fm-ubt4 fs_16 pr_10 pl_10 pt_3 pb_4 t_d_n color_1 b_r_3 bcolor_5 hbcolor_4 abcolor_4 box-s1" href="{{ route("user.index") }}">Cancel</a>
@endsection
            ...
            <div class="xl-6 lg-6 md-12 sm-12 order-0">
                <div class="pr_10 pl_10">
                    <div class="_0auto w_100 pt_10">
                        <img class="w_100 b_r_c box-s1" src="{{ asset($user->photo == "" ? "icon/member.svg" : "photo/".$user->photo."_thumb.jpg") }}" alt="">
                    </div>
                    <div>
