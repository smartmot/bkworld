...
<div>
    <div class="pt_10">
        <form action="{{ route("page.store") }}" method="post" spellcheck="false" autocomplete="off">
            ...
            <div class="pb_15">
                <label class="ds_f p-r">
                    <input type="text" name="slug" value="{{ old("slug") }}" class="input-1 box-s1 fm-popp wp_100 pd-10x15 fs_16 oln_n bd_n b_r_3" placeholder="Slug">
            ...
            <div class="pb_15">
                <label class="ds_f p-r">
                    <input type="text" name="keyword" value="{{ old("keyword") }}" class="input-1 box-s1 fm-popp wp_100 pd-10x15 fs_16 oln_n bd_n b_r_3" placeholder="Keyword">
                </label>
                @error("keyword")
                <div class="t_a_r">
                    <span class="pr_15 pl_15 bcolor_4 fm-popp fs_14 color_1">{{ $message }}</span>
            ...
            <div class="pb_15">
                <label class="ds_f p-r">
                    <input type="text" name="description" value="{{ old("description") }}" class="input-1 box-s1 fm-popp wp_100 pd-10x15 fs_16 oln_n bd_n b_r_3" placeholder="Description">
                </label>
                @error("description")
                <div class="t_a_r">
                    <span class="pr_15 pl_15 bcolor_4 fm-popp fs_14 color_1">{{ $message }}</span>
            ...
            <div class="pb_10">
                <label class="ds_f p-r">
                    <textarea rows="8" name="content" placeholder="Content" class="input-1 box-s1 fm-popp wp_100 pd-10x15 fs_16 oln_n bd_n b_r_3">{{ old("content") }}</textarea>
                </label>
                @error("content")
                <div class="t_a_r">
                    <span class="pr_15 pl_15 bcolor_4 fm-popp fs_14 color_1">{{ $message }}</span>
